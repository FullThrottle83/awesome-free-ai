...
- 💸 [**Pieces for Developers**](https://pieces.app/) - On-device AI companion for developer workflow intelligence.
...
- 💸 [**Sourcegraph Cody Free**](https://sourcegraph.com/cody) - AI coding assistant with deep codebase context.
  - **Free Tier Details:** Provides 500,000 tokens of context per month and 200 chat/commands.
  - **Tags:** `code-assistant`, `context-aware`, `developer-tool`, `freemium`
- 💸 [**SQLAI.ai**](https://ai.bizequals.com/sqlaiai) - AI assistant for SQL/NoSQL optimization.
...
- 💸 [**Tabnine Basic**](https://www.tabnine.com/) - AI code completion and chat.
  - **Free Tier Details:** Provides basic short-code completions using an in-built local smaller model.
  - **Tags:** `code-completion`, `ai-assistant`, `developer-tool`, `freemium`
- 💸 [**testRigor Community Edition**](https://testrigor.com/) - No-code test generation with natural language.
...
- 💿 [**Argo CD**](https://argo-cd.readthedocs.io/en/stable/) - Open-source GitOps continuous delivery tool.
...
- 💿 [**BackstopJS**](https://garris.github.io/BackstopJS/) - Open-source visual regression testing tool.
...
- 💿 [**CodeQL OSS**](https://codeql.github.com/) - Open-source SAST for research and open source projects.
...
- 💿 [**Continue.dev**](https://www.continue.dev/) - Open-source, model-agnostic code assistant.
...
- 💿 [**GFPGAN**](https://github.com/TencentARC/GFPGAN) - Open-source AI for face and portrait restoration.
...
- 💿 [**Great Expectations**](https://greatexpectations.io/) - Open-source Python library for data validation.
...
- 💿 [**Real-ESRGAN**](https://github.com/xinntao/Real-ESRGAN) - Open-source AI image upscaling.
...
- 💿 [**Upscayl**](https://www.upscayl.org/) - Open-source AI image upscaling.
...
- 💿 [**Visual Regression Tracker**](https://visualregressiontracker.com/) - Open-source visual regression testing tool.
...
- 💸 [**Anthropic API**](https://www.anthropic.com/api) - Access to Claude models for developers.
...
- 🎁 [**DeepL API Free**](https://www.deepl.com/pro-api) - High-quality machine translation API.
  - **Free Tier Details:** 500,000 characters per month for free.
  - **Tags:** `translation-api`, `nmt`, `api`, `free`
- 🎁 [**DeepSeek**](https://www.deepseek.com/en) - Large Language Model API.
  - **Free Tier Details:** Claims to have no rate limits on its API, even for free access.
  - **Tags:** `llm-api`, `no-rate-limit`, `free-api`
- 💸 [**Google Gemini API**](https://ai.google.dev/gemini-api/docs/pricing) - Access to Gemini models for developers.
  - **Free Tier Details:** Free access via API with rate limits of 5 RPM and 25 RPD.
  - **Tags:** `llm-api`, `api-access`, `freemium`, `multimodal`
- 🎁 [**Google Translate API**](https://cloud.google.com/translate/pricing) - Machine translation API.
  - **Free Tier Details:** 500,000 characters per month for free for API usage.
  - **Tags:** `translation-api`, `multilingual`, `api`, `free`
- 🎁 [**Hugging Face Spaces (CPU Spaces)**](https://huggingface.co/spaces) - CPU-powered environment for hosting AI demos and applications.
...
- 🎁 [**Hugging Face ZeroGPU**](https://huggingface.co/docs/hub/spaces-zerogpu) - Free serverless GPU access for AI demos.
...
- 🎁 [**Meta Llama 3.2 (via Together AI)**](https://www.together.ai/models/llama-3.2.11b-free) - Open-source Large Language Model hosted via third-party providers.
...
- 💸 [**Modal Labs**](https://modal.com/) - Serverless GPU hosting for AI/ML models.
...
- 💸 [**OpenRouter**](https://openrouter.ai/) - API for accessing various large language models.
...
- 💸 [**Amplitude (Free)**](https://amplitude.com/pricing) - Product analytics platform.
...
- 💿 [**Apache Superset**](https://superset.apache.org/) - Open-source data visualization and exploration platform.
...
- 💸 [**Databricks Community Edition**](https://community.cloud.databricks.com/) - Data lakehouse platform for machine learning.
...
- 💸 [**Grafana Cloud (Free)**](https://grafana.com/products/cloud/free-tier/) - Observability platform for metrics, logs, and traces.
...
- 💿 [**Grafana Loki + GPT**](https://grafana.com/oss/loki/) - Log aggregation and AI-powered log anomaly detection.
...
- 💿 [**JupyterHub (open source)**](https://jupyter.org/hub) - Multi-user server for Jupyter notebooks.
...
- 💿 [**Metabase (OSS)**](https://www.metabase.com/) - Open-source business intelligence (BI) tool.
...
- 💸 [**Mixpanel (Free)**](https://mixpanel.com/pricing/) - Product analytics platform.
...
- 💸 [**Observable Notebooks**](https://observablehq.com/) - JavaScript-based notebooks for data visualization and analysis.
...
- 💸 [**PostHog (Free)**](https://posthog.com/pricing) - Product analytics platform.
...
- 💿 [**Simple Loki MCP Server**](https://www.flowhunt.io/sv/mcp-servers/simple-loki-mcp/) - Open-source log management with AI log search.
...
- 🎁 [**Streamlit Community Cloud**](https://streamlit.io/cloud) - Platform for hosting data applications.
...
- 💸 [**Tableau Public**](https://public.tableau.com/s/) - Visual analytics platform for public data.
...
- 💸 [**Activepieces**](https://www.activepieces.com/) - Open-source, no-code automation platform.
...
- 💸 [**Airtable AI**](https://www.airtable.com/ai) - App builder with AI features for data management.
  - **Free Tier Details:** 15,000 AI credits per month per free seat.
  - **Tags:** `no-code`, `database`, `ai-features`, `freemium`
- 💸 [**Coda AI**](https://coda.io/product/ai) - Document with integrated AI features.
...
- 💸 [**Fathom**](https://fathom.video/) - AI meeting notetaker with unlimited recording and transcription.
...
- 🎁 [**Gmail Smart Compose, Summarize, Help Me Write**](https://www.google.com/gmail/about/) - AI-powered email composition and assistance.
...
- 🎁 [**Google Sheets AI**](https://docs.google.com/spreadsheets/) - Spreadsheet with integrated AI features.
...
- 💸 [**Grain**](https://grain.com/) - AI notetaker for meeting insights.
...
- 💸 [**Grammarly**](https://www.grammarly.com/) - Generative AI writing assistant and grammar checker.
...
- 💸 [**HARPA/Merlin**](https://harpa.ai/) - Multi-purpose AI toolbox for any webpage.
  - **Free Tier Details:** Provides a unified interface to access various leading LLMs on any webpage.
  - **Tags:** `ai-toolbox`, `web-automation`, `content-creation`, `freemium`
- 💸 [**IFTTT**](https://ifttt.com/) - Basic automation for applets and webhooks.
...
- 💸 [**LanguageTool**](https://languagetool.org/) - Grammar, spelling, and style checker.
...
- 💸 [**LINER**](https://liner.ai/) - AI Copilot for web research and annotation.
...
- 💿 [**Logseq + AI-lab**](https://logseq.com/) - Local-first knowledge management with experimental AI.
...
- 🎁 [**Mailmeteor AI Email Writer**](https://mailmeteor.com/tools/ai-email-writer) - AI tool for generating professional emails.
...
- 💸 [**Make (Integromat)**](https://www.make.com/) - No-code workflow automation with AI.
...
- 🎁 [**Microsoft Excel AI (Excel Online)**](https://www.microsoft.com/en-us/microsoft-365/free-online-version-of-microsoft-excel) - Online spreadsheet with AI capabilities.
...
- 💿 [**Obsidian + AI-plugins**](https://obsidian.md/) - Markdown-based knowledge management with AI plugins.
...
- 🎁 [**Outlook MailMaestro-plugin**](https://www.mailmaestro.ai/) - AI plugin for Outlook email composition.
...
- 💸 [**Pipedream**](https://pipedream.com/) - Serverless workflow automation with AI integration.
...
- 💸 [**ProWritingAid**](https://prowritingaid.com/) - Writing enhancement and grammar checker.
...
- 💸 [**Reclaim.ai**](https://reclaim.ai/) - AI scheduling assistant.
...
- 💸 [**Reverso translation**](https://www.reverso.net/) - Context-based translation.
...
- 💸 [**Sapling AI**](https://sapling.ai/) - Grammar, style, and fluency suggestions.
...
- 🎁 [**Scribe**](https://scribehow.com/) - Tool for capturing processes and generating step-by-step manuals.
...
- 🎁 [**Slack Konversationssammanfattningar**](https://slack.com/) - AI-powered conversation summaries for communication.
...
- 🎁 [**WriterHand AI Script Generator**](https://writerhand.com/tools/ai-script-generator) - AI script generator for various media.
...
- 🎁 [**Wrizzle (Story Generator)**](https://www.wrizzle.ai/) - AI story generator.
...
- 🎁 [**You.com AI Writer**](https://you.com/chat) - Unlimited free text generation and research agent.
...
- 💸 [**Zapier**](https://zapier.com/) - AI-enhanced workflow automation.
