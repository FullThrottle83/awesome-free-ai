...
[![GitHub Stars](https://img.shields.io/github/stars/FullThrottle83/awesome-free-ai?style=flat&color=black)](https://github.com/FullThrottle83/awesome-free-ai/stargazers)
[![Last Commit](https://img.shields.io/github/last-commit/FullThrottle83/awesome-free-ai?style=flat&color=purple)](https://github.com/FullThrottle83/awesome-free-ai/commits)
...
- 💸 [Adobe Firefly](https://firefly.adobe.com/) - An AI image generation, video, audio, and vector features platform.
...
- 💸 [Artbreeder](https://www.artbreeder.com/) - An AI tool for image generation, mixing, and splicing.
...
- 🎁 [Craiyon](https://www.craiyon.com/) - An unlimited image generation tool with attribution.
...
- 🎁 [DeepAI](https://deepai.org/) - An unlimited text-to-image generation service.
...
- ⚠️ [Ideogram.ai](https://ideogram.ai/) - An AI image generation tool with superior text rendering.
...
- 💸 [NightCafe](https://nightcafe.studio/) - An AI art generation tool with community features.
...
- 💸 [StarryAI](https://starryai.com/) - An AI art generation platform with mobile apps.
...
- 💿 [Waifu2x](http://waifu2x.udp.jp/) - An AI image upscaler for anime-style art and photos.
...
- ⚠️ [Suno AI](https://suno.ai/) - An AI music generation tool with commercial rights.
...
- 💸 [Udio](https://www.udio.com/) - An AI music generation platform.
...
- ⚠️ [CapCut](https://www.capcut.com/) - An AI-powered video editing and creation tool.
...
- 💸 [ElevateAI](https://www.elevateai.com/) - An AI platform for transcription and generative AI features.
  - **Free Tier Details:** The "1K Every Day" program provides 1,000 free interactions daily (transcription, GenAI features). This is a permanent, substantive free tier.
...
- 🎁 [Google NotebookLM](https://notebooklm.google.com/) - An AI-powered research assistant grounded in your source documents.
...
- ⚠️ [Paperpal](https://paperpal.com/) - An academic writing assistant.
...
- 💸 [Google Gemini](https://gemini.google.com/) - A multimodal AI for data analysis and content generation.
...
- 🎁 [HuggingFace Chat](https://huggingface.co/chat/) - A free and open-source chat with various LLMs.
...
- ⚠️ [Mistral Le Chat](https://chat.mistral.ai/) - An AI assistant from Mistral AI.
...
- ⚠️ [xAI Grok](https://grok.com/) - An AI model with real-time information and multimodal features.
...
- 💸 [Amazon CodeWhisperer (Individual)](https://aws.amazon.com/codewhisperer/) - An AI code suggestions and security scanning tool.
...
- ⚠️ [Codeium](https://www.codeium.com/) - An unlimited AI code completion and chat tool.
...
- ⚠️ [GitHub Copilot](https://github.com/features/copilot) - An AI pair programmer.
...
- 💿 [HARPA AI](https://harpa.ai/) - An open source AI toolbox with BYOK support.
...
- 💸 [Sourcegraph Cody Free](https://sourcegraph.com/cody) - An AI coding assistant with deep codebase context.
...
- 💿 [Playwright MCP Server](https://github.com/microsoft/playwright-python) - An LLM-driven browser automation and test generation tool.
...
- 🎁 [DeepSeek](https://www.deepseek.com/en) - A Large Language Model API.
  - **Free Tier Details:** Claims to have no rate limits on its API, even for free access.
  - **Tags:** `llm-api`, `no-rate-limit`, `free-api`
- 💸 [Google Gemini API](https://ai.google.dev/gemini-api/docs/pricing) - An API providing access to Gemini models for developers.
...
- 💸 [HARPA/Merlin](https://harpa.ai/) - A multi-purpose AI toolbox for any webpage.
